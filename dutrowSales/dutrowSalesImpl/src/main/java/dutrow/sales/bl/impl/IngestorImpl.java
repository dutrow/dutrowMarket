...
public class IngestorImpl implements Ingestor{
	private static Log log = LogFactory.getLog(IngestorImpl.class);
	...
	public IngestorImpl(AccountDAO accountDaoIn, AuctionDAO auctionDaoIn){
	 ...
	 * @param accountDao2
	 */
	public IngestorImpl(InputStream is, JPAAccountDAO accountDaoIn,
