...
3.		eBidbot Business Logic :: [INCOMPLETE]
3.A.	OrderMgmt/OrderMgmtImpl :: [INCOMPLETE]
4.		Create an EJB tier to host your eBidbot business logic and data access tiers. [INCOMPLETE]
4.A.	WAR:  [INCOMPLETE]
4.B.	EJBs: [INCOMPLETE]
4.B.a.	OrderMgmtEJB: [INCOMPLETE]
4.C.	DTOs: [INCOMPLETE]
